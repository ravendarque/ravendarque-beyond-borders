        ...
        <div className="icon" aria-hidden="true">
          ...
          >
            <g transform="translate(-.26504)">
              <path
                d="m336.02 1345.9c-184.43-526.94-335.52-959.07-335.75-960.29-0.3893-2.01 102.58-49.62 107.31-49.61 0.96168 0.001 743.15 1889.5 744.16 1894.5 0.3655 1.8202-174.51 73.476-179.32 73.476-0.59033 0-151.97-431.14-336.4-958.09z"
                fill="currentColor"
              />
              <path
  ...
  return (
    <>
      <div className="flag-preview-wrapper">
        <div className="flag-preview" style={{ aspectRatio: `${aspectRatio} / 1` }}>
          <img
            ref={imgRef}
            src={imageUrl}
        ...
        <button className="flag-about-link" onClick={() => setShowDetailsModal(true)} type="button">
          <svg
            width="14"
            height="14"
            viewBox="0 0 24 24"
      ...
      <FlagDetailsModal open={showDetailsModal} onOpenChange={setShowDetailsModal} flag={flag} />
    </>
  );
});
