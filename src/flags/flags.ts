...
export const flags: FlagSpec[] = [
  {
    ...
    references: [
      ...
      },
      {
        ...
        text: 'UNRWA: Two Years of War - Fast Facts',
      },
      {
        url: 'https://www.amnesty.org/en/location/middle-east-and-north-africa/israel-and-occupied-palestinian-territories/report-israel-and-occupied-palestinian-territories/',
        text: 'Amnesty International: Human rights in Israel and Occupied Palestinian Territories',
      },
      {
  ...
  },
  {
    ...
    references: [
      ...
      },
      {
        ...
        text: 'Amnesty International: Human rights in China',
      },
      {
  ...
  },
  {
    ...
    references: [
      ...
      {
        url: 'https://www.amnesty.org/en/location/africa/west-and-central-africa/western-sahara/report-western-sahara/',
        text: 'Amnesty International: Human rights in Western Sahara',
      },
      {
  ...
  },
  {
    ...
    references: [
      ...
      {
        url: 'https://www.amnesty.org/en/location/europe-and-central-asia/ukraine/report-ukraine/',
        text: 'Amnesty International: Human rights in Ukraine',
      },
      {
    ...
    references: [
      {
        ...
        text: 'Flag of Australian Aboriginal on Wikipedia',
      },
      {
        url: 'https://www.amnesty.org/en/location/asia-and-the-pacific/australia-and-pacific/australia/report-australia/',
        text: 'Amnesty International: Human rights in Australia',
      },
      {
    ...
    references: [
      {
        ...
        text: 'Flag of Iran on Wikipedia',
      },
      {
      ...
      },
      {
        ...
        text: 'Amnesty International: Iran massacre of protesters demands global diplomatic action',
      },
      {
    ...
    references: [
      {
        ...
        text: 'Flag of Sudan on Wikipedia',
      },
      {
        url: 'https://www.amnesty.org/en/location/africa/east-africa-the-horn-and-great-lakes/sudan/report-sudan/',
        text: 'Amnesty International: Human rights in Sudan',
      },
      {
        url: 'https://sudan.un.org/en/301357-%E2%80%9C-war-atrocities%E2%80%9D-sudan-civilians-deliberately-targeted-un-fact-finding-mission-reports',
        text: 'UN: War atrocities in Sudan - civilians deliberately targeted',
      },
      {
        url: 'https://www.oxfam.org/en/research/sudan-crisis-two-years',
        text: 'Oxfam: Sudan crisis, two years on',
      },
      {
  ...
  {
    id: 'the-democratic-republic-the-congo',
    name: 'Flag of the Democratic Republic of the Congo',
    displayName: 'Congo (DRC)',
    png_full: 'the-democratic-republic-the-congo.png',
    ...
    references: [
      {
        ...
        text: 'Flag of the Democratic Republic of the Congo on Wikipedia',
      },
      {
        url: 'https://www.amnesty.org/en/latest/news/2025/08/drc-warring-factions-in-eastern-drc-commit-horrific-abuses-including-gang-rapes-summary-executions-and-abductions/',
        text: 'Amnesty International: DRC warring factions commit horrific abuses',
      },
      {
        url: 'https://www.hrw.org/news/2025/05/23/dr-congo-army-backed-militias-abuse-civilians-south-kivu',
        text: 'Human Rights Watch: DR Congo - Army-backed militias abuse civilians',
      },
      {
        url: 'https://www.unicef.org/press-releases/reports-grave-violations-against-children-eastern-democratic-republic-congo-tripled',
        text: 'UNICEF: Grave violations against children in eastern DRC tripled',
      },
      {
    ...
    references: [
      {
        ...
        text: 'Flag of Myanmar on Wikipedia',
      },
      {
        url: 'https://www.amnesty.org/en/latest/news/2025/01/myanmar-four-years-after-coup-world-must-demand-accountability-for-atrocity-crimes/',
        text: 'Amnesty International: Myanmar - Four years after coup, world must demand accountability',
      },
      {
      ...
      {
        url: 'https://childrenandarmedconflict.un.org/2025/04/myanmar-sharp-increase-in-grave-violations-against-children/',
        text: 'UN: Myanmar - Sharp increase in grave violations against children',
      },
      {
    ...
    references: [
      {
        ...
        text: 'Flag of Rainbow on Wikipedia',
      },
      {
        url: 'https://www.amnesty.org/en/what-we-do/discrimination/lgbti-rights/',
        text: 'Amnesty International: LGBTI rights',
      },
      {
    ...
    references: [
      {
        ...
        text: 'Flag of Transgender on Wikipedia',
      },
      {
        url: 'https://www.amnesty.org/en/what-we-do/discrimination/lgbti-rights/',
        text: 'Amnesty International: LGBTI rights',
    ...
    references: [
      {
        ...
        text: 'Flag of Non-Binary on Wikipedia',
      },
      {
        url: 'https://www.amnesty.org/en/what-we-do/discrimination/lgbti-rights/',
        text: 'Amnesty International: LGBTI rights',
  ...
  {
    id: 'lgbtq-rainbow-quasar-progress-variant',
    name: 'Progress Pride Flag',
    displayName: 'Pride Progress',
    png_full: 'lgbtq-rainbow-quasar-progress-variant.png',
    png_preview: 'lgbtq-rainbow-quasar-progress-variant.preview.png',
    aspectRatio: 1.5753846153846154,
    svgFilename: 'lgbtq-rainbow-quasar-progress-variant.svg',
    category: 'lgbtqia',
    categoryDisplayName: 'LGBTQIA+',
    categoryDisplayOrder: 4,
    ...
    references: [
      {
        ...
        text: 'Progress Pride Flag on Wikipedia',
      },
      {
        url: 'https://www.amnesty.org/en/what-we-do/discrimination/lgbti-rights/',
        text: 'Amnesty International: LGBTI rights',
  ...
  {
    id: 'intersex-inclusive-pride',
    name: 'Progress Pride Flag (Intersex-Inclusive)',
  ...
  },
  {
    id: 'asexual-pride',
    name: 'Asexual Flag',
    displayName: 'Asexual Pride',
    png_full: 'asexual-pride.png',
    png_preview: 'asexual-pride.preview.png',
    aspectRatio: 1.6666666666666667,
    svgFilename: 'asexual-pride.svg',
    category: 'lgbtqia',
    categoryDisplayName: 'LGBTQIA+',
    categoryDisplayOrder: 4,
  ...
  },
  {
    ...
    displayName: 'Genderqueer Pride',
    png_full: 'genderqueer-pride.png',
    png_preview: 'genderqueer-pride.preview.png',
    aspectRatio: 1.6666666666666667,
    svgFilename: 'genderqueer-pride.svg',
    category: 'lgbtqia',
    categoryDisplayName: 'LGBTQIA+',
    categoryDisplayOrder: 4,
  ...
  },
  {
    id: 'bisexual-pride',
    name: 'Bisexual Flag',
    displayName: 'Bisexual Pride',
    png_full: 'bisexual-pride.png',
    png_preview: 'bisexual-pride.preview.png',
    aspectRatio: 1.6666666666666667,
    svgFilename: 'bisexual-pride.svg',
    category: 'lgbtqia',
    categoryDisplayName: 'LGBTQIA+',
    categoryDisplayOrder: 4,
    ...
    references: [
      {
        ...
        text: 'Bisexual Flag on Wikipedia',
      },
      {
        url: 'https://www.amnesty.org/en/what-we-do/discrimination/lgbti-rights/',
        text: 'Amnesty International: LGBTI rights',
  ...
  {
    id: 'pansexuality-pride',
    name: 'Pansexual Flag',
    displayName: 'Pansexual Pride',
    png_full: 'pansexuality-pride.png',
    png_preview: 'pansexuality-pride.preview.png',
    aspectRatio: 1.6666666666666667,
    svgFilename: 'pansexuality-pride.svg',
    category: 'lgbtqia',
    categoryDisplayName: 'LGBTQIA+',
    categoryDisplayOrder: 4,
    ...
    references: [
      {
        ...
        text: 'Pansexual Flag on Wikipedia',
      },
      {
        url: 'https://www.amnesty.org/en/what-we-do/discrimination/lgbti-rights/',
        text: 'Amnesty International: LGBTI rights',
  ...
  {
    id: 'antifa-logo',
    name: 'Antifascist Logo',
    displayName: 'Antifa',
    png_full: 'antifa-logo.png',
    ...
    references: [
      {
        ...
        text: 'Antifa (United States) on Wikipedia',
      },
      {
        url: 'https://en.wikipedia.org/wiki/Antifaschistische_Aktion',
        text: 'Antifaschistische Aktion on Wikipedia',
      },
      {
        url: 'https://www.amnesty.org/en/what-we-do/freedom-of-assembly/',
        text: 'Amnesty International: Freedom of assembly',
      },
      {
  ...
  },
  {
    ...
    references: [
      ...
      {
        url: 'https://www.amnesty.org/en/location/middle-east-and-north-africa/turkey/report-turkey/',
        text: 'Amnesty International: Human rights in Turkey',
      },
      {
