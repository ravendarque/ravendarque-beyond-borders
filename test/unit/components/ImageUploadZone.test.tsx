...
describe('ImageUploadZone', () => {
  it('should render file input with correct attributes', () => {
    ...
    render(<ImageUploadZone imageUrl={null} onImageUpload={onImageUpload} onShowPrivacy={onShowPrivacy} />);
  ...
  it('should apply has-image class when imageUrl is provided', () => {
    ...
    render(<ImageUploadZone imageUrl={imageUrl} onImageUpload={onImageUpload} onShowPrivacy={onShowPrivacy} />);
  ...
  it('should set background image style when imageUrl is provided', () => {
    ...
    // happy-dom normalizes backgroundPosition to "center center"
    expect(label.style.backgroundPosition).toContain('center');
  });
