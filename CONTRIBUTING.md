...
By contributing to this repository (via pull request or otherwise), you agree that:

1. **Your contributions will not enable harmful use:**
   - You will not add flags or symbols that promote oppression
   - You will not enable creation of nationalist/racist flags
   - You will not support discrimination against marginalized groups

2. **Your contributions align with the project's mission:**
   - Supporting marginalized groups
   - Raising awareness for oppressed peoples
   - Showing solidarity with stateless nations

3. **The maintainer reserves the right to:**
   - Reject any contribution that violates these terms
   - Revoke access to the repository for violations
   - Remove contributions that enable harmful use
...
- Contributions that violate ethical use restrictions will be rejected
- Accepted contributions become part of the project under the same license
- You retain copyright but grant license to the project
